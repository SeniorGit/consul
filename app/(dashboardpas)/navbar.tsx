...
export default function Sidebar() {
  ...
  return (
    <div>
      ...
      <div className="hidden lg:flex w-20 bg-gradient-to-b from-[#4D9CE1] to-[#003A7C] text-white flex-col justify-between items-center py-6 rounded-[10px] sticky top-0 min-h-screen"> {/* min-h-screen instead of h-screen */}
