        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div className="mt-4 bg-[#4C82CB] text-black shadow-lg rounded-lg p-4 flex flex-col md:flex-row justify-between items-center">
                ...
                <Link href="/dashpas/chat">
                  <button className="bg-[#264065] text-white px-4 py-2 rounded-lg">
                    Chat Now!
                  </button>
                </Link>
              </div>

              <div className="mt-4 bg-white text-black shadow-lg rounded-lg p-4 flex flex-col md:flex-row justify-between items-center">
                <div className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Link href="/dashpas/booking">
                  <div className="bg-white rounded-lg flex flex-col items-center shadow-lg">
                    <div className="w-full rounded-[10px] bg-gradient-to-t from-[#4D9CE1] to-[#003A7C] flex justify-center p-4">
                      <Image src="/images/dash2.png" alt="Counseling via Chat" width={70} height={70} />
                    </div>
                    <h4 className="font-semibold text-center mt-4">
