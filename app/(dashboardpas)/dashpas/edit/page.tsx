            ...
            <div className="bg-white p-6 rounded-lg shadow-lg space-y-6">
              <div className="flex items-start space-x-6">
                <div className="flex flex-col items-center">
                  ...
                  />
                  <button className="text-blue-500 underline mt-2">change photo</button>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 rounded-lg p-2 mt-1 bg-[#4C82CB] text-white"
                      />
                    </div>
          ...
          <div>
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center justify-between">
                Your Treatment 
                <span className="ml-2">
                  <Image src="/icons/notification-bell.png" alt="bell icon" width={20} height={20} />
                </span>
              </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-xl shadow-md flex items-start space-x-4">
                  ...
                  />
                  <div className="flex-1">
                    <h3 className="font-bold text-[#27374D]">Pito S.Psi, M.Psi. Psychologists</h3>
                    <p className="text-sm text-gray-600">Bandung, Jawa Barat</p>
                    <div className="mt-2 space-y-2 text-sm text-gray-600">
                      <div>
                        <span className="font-bold">Date</span>
