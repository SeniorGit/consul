        ...
        <div className="flex flex-col items-center justify-center">
          <div className="px-10 py-10 bg-[#27374D] text-center rounded-[20px]">
            <h1 className="sm:text-4xl leading-snug mb-4">
              <span className="block font-bold text-white text-[50px]">Login</span> 
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mt-8">  
              <Link href="/loginpsi" className="bg-[#27374D] w-[200px] sm:w-[250px] lg:w-[300px] p-5 rounded-[20px] shadow-lg cursor-pointer transition-transform transform duration-300">
              ...
              <Link href="/loginpas" className="bg-[#27374D] w-[200px] sm:w-[250px] lg:w-[300px] p-5 rounded-[20px] shadow-lg cursor-pointer transition-transform transform duration-300">
                <div className="overflow-hidden rounded-md bg-[#1F2A3D] p-2">
                  <Image
                    src="/images/pas.png" 
                    alt="Patient"
