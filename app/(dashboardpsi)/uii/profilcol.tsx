      ...
      <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-[1000px]' : 'max-h-0'}`}>
        <div className="p-4 sm:p-6">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-[18px] sm:text-[20px] font-bold mt-4 text-center">
              Isey S.Psi, M.Psi, Psychologist
            </h2>
          ...
          <div className="mt-1 sm:ml-[60px]">
            ...
            <div className="flex items-center space-x-2 px-4 py-2 mt-2">
              <Image src="/icons/calendarb.png" alt="Calendar Icon" width={20} height={16} />
